...
#[test]
fn таблица_совпадает_с_pow_mod_на_всех_показателях_двух_байт() {
...
#[test]
fn таблица_совпадает_на_показателе_боевой_длины() {
...
#[test]
fn таблица_верна_и_когда_запись_многословная() {
...
#[test]
fn нулевой_показатель_даёт_единицу() {
